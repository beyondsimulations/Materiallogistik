---
title: "Vorlesung 05: Bestandspolitiken"
subtitle: "Newsvendor-Problem, (s,q)-Politik, (r,S)-Politik"
author: "Tobias Vlćek"
...
4.  **$v_{opt}$ finden:** 
    - Wir suchen den `v`-Wert, für den $G_Z^{(1)}(v) \leq 0.05$ ist. Aus der Tabelle finden wir, dass $G_Z^{(1)}(1.3) \approx 0.046$ der erste Wert ist, der die Bedingung erfüllt. Also $v_{opt} \approx 1.3$.
5.  **Bestellniveau $S_{opt}$:**
    $S_{opt} = 200 + 1.3 \cdot 30 = 200 + 39 = 239$ Packungen.
    Jeden dritten Tag wird so viel Milch bestellt, dass der verfügbare Bestand wieder auf 239 Packungen ansteigt.
