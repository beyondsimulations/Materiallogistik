...
*   **Standardisierte Verlustfunktion ($G_u(z)$):** $G_u(z) = \phi(z) - z(1 - \Phi(z))$
    ...
    *   $\Phi(z)$: Kumulative Verteilungsfunktion der Standardnormalverteilung. Beachten Sie, dass $1 - \Phi(z)$ genau der Fehlbestandswahrscheinlichkeit $(1-\alpha)$ entspricht.
