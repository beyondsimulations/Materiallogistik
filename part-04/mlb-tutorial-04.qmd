...
for t in range(1, T + 1):
    ...
    if disp_bestand <= s:
        ...
        # Wichtig: Disponibler Bestand ändert sich durch die Bestellung NICHT.
        
    results.append({
        'Woche (t)': t,
        'Nachfrage $d_t$': demand_t,
        'Disp. Bestand (Anfang)': disp_bestand_anfang,
        'Bestellung? (Menge)': bestellung_getaetigt,
        'Disp. Bestand (Ende)': disp_bestand,
        'Phys. Bestand (Ende)': phys_bestand,
        'Bestellbestand (Ende)': bestell_bestand,
        'Fehlbestand (Ende)': fehl_bestand
    })
...
-   **P(Y2 = 0):** Nur wenn $D_1=0$ und $D_2=0$.
    $P(Y_2=0) = P(D=0) \cdot P(D=0) = 0.2 \cdot 0.2 = 0.04$
-   **P(Y2 = 1):** Wenn ($D_1=0, D_2=1$) oder ($D_1=1, D_2=0$).
    $P(Y_2=1) = P(0,1) + P(1,0) = (0.2 \cdot 0.6) + (0.6 \cdot 0.2) = 0.12 + 0.12 = 0.24$
-   **P(Y2 = 2):** Wenn ($D_1=0, D_2=2$), ($D_1=1, D_2=1$), oder ($D_1=2, D_2=0$).
    $P(Y_2=2) = P(0,2) + P(1,1) + P(2,0) = (0.2 \cdot 0.2) + (0.6 \cdot 0.6) + (0.2 \cdot 0.2) = 0.04 + 0.36 + 0.04 = 0.44$
-   **P(Y2 = 3):** Wenn ($D_1=1, D_2=2$) oder ($D_1=2, D_2=1$).
    $P(Y_2=3) = P(1,2) + P(2,1) = (0.6 \cdot 0.2) + (0.2 \cdot 0.6) = 0.12 + 0.12 = 0.24$
-   **P(Y2 = 4):** Nur wenn $D_1=2$ und $D_2=2$.
    $P(Y_2=4) = P(2,2) = 0.2 \cdot 0.2 = 0.04$
